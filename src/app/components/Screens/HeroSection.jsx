...
const HeroSection = () => {
  return (
    <section id="hero_id" className="lg:py-16">
      <div className="grid grid-cols-1 sm:grid-cols-12">
        ...
        >
          ...
          <div>
            <Link
              href="/#contact"
              className="px-6 inline-block py-3 w-full sm:w-fit rounded-full mr-4 theme1"
            >
              Hire Me
            </Link>
            <Link
            ...
            >
              <span className="block theme1 rounded-full  px-5 py-2">
                Download CV
              </span>
            </Link>
          </div>
