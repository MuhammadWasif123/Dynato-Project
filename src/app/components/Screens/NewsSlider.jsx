...
const NewsSlider = () => {
  return (
    <div className="h-[24vh] flex items-center justify-center md:h-screen px-4">
      <Swiper
        breakpoints={{
          340: {
            slidesPerView: 1,
      ...
      >
        {CardData.map((item) => (
          <SwiperSlide key={item.title}>
            <div className="flex flex-col gap-4 mb-10 group relative shadow-lg text-white rounded-xl px-4 py-6 sm:py-8 h-[250px] sm:h-[300px] lg:h-[390px] w-full sm:w-[300px] lg:w-[320px] overflow-hidden cursor-pointer lg:mr-[30px]">
              <div
              ...
              <div className="z-10 flex items-center justify-between relative top-[45px] w-full ">
                <RxArrowTopRight className="w-[24px] sm:w-[35px] h-[24px] sm:h-[35px] text-white group-hover:text-blue-500 group-hover:rotate-45 duration-100" />
                <div className="user w-full sm:w-[84%] relative sm:left-[105px]">
                  <Image
                    src={item.Image2}
                    alt="hero image"
